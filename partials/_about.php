<div class='section'>
	<h4>What we do</h4>
		<h5>Design</h5>
		<p>There is no job too big or too small for Praxis Homes. We provide a complete design service from small projects like color consulation or a total room transformation. We will be involved any project large or small; so let the Praxis Home's designers help make your home the one you have always dreamed of.</p>
		<h5>Realty</h5>
		<p>We offer full realty services from buying, selling, and rental properties. Our realty services are brokered through Rogers Healy and Associates, so we make sure your listing gets maxiumum exposure; not only through Praxis Homes but also through the entire Roger's Healy network. You can always choose to use both our realty and designs services and let us turn your new home into the home we know it can be.</p>

</div>

<div class='section'>
	<h4>Why choose Praxis Homes</h4>
		...
		<div class="row small-up-1 medium-up-2 large-up-3">
			<div class="column">
				<img src="images/front-gallery-1.jpg" />
			</div>
			<div class="column">
				<img src="images/front-gallery-2.jpg" />
			</div>
			<div class="column">
				<img src="images/front-gallery-3.jpg" />
			</div>
		</div>
